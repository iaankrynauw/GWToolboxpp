...
#define LOAD_INT(var) var = static_cast<int>(ini->GetLongValue(Name(), #var, static_cast<long>(var)));
#define SAVE_INT(var) ini->SetLongValue(Name(), #var, static_cast<long>(var));
